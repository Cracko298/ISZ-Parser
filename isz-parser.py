...
for file_index in range(3):
    ...
    if exists(file_name):
        with open(file_name, 'rb+') as data_file:
            ...
            if "Defualt" in backpacks:
                pass
            elif "Camo" in backpacks:
                inv_slots += 3
            elif "Military" in backpacks:
                inv_slots += 6
            elif "Kevlar" in backpacks:
                inv_slots += 9
            elif "Arctic" in backpacks:
                inv_slots += 12
            elif "Bling" in backpacks:
                inv_slots += 15
            elif "Corrupted" in backpacks:
                inv_slots = None
            else:
                inv_slots += 15
            ...
            if "Defualt" in jackets:
                pass
            elif "Corrupted" in jackets:
                pass
            elif "Camo" in jackets:
                warmth += 1
                armor += 1
            elif "Military" in jackets:
                armor += 2
            elif "Kevlar" in jackets:
                armor += 5
            elif "Arctic" in jackets:
                warmth += 5
            elif "Bling" in jackets:
                warmth += 2
                armor += 2
            else:
                warmth += 9999
            ...
            if "Defualt" in trousers:
                pass
            elif "Corrupted" in trousers:
                pass
            elif "Camo" in trousers:
                warmth += 1
                armor += 1
            elif "Military" in trousers:
                armor += 2
            elif "Kevlar" in trousers:
                armor += 5
            elif "Arctic" in trousers:
                warmth += 5
            elif "Bling" in trousers:
                warmth += 2
                armor += 2
            else:
                warmth += 9999
            ...
            save_data[f"Data{file_index} File Information"] = {
                "Header Length": 0x20,
                "SaveGame Length": file_len,
                "Header + SaveGame Length":total_len,
                "Estimated File Size": f"{round(total_len/1024, 3)}kb",
                "Game Opened": open_byte,
                "Level Saved": open_byte,
            ...
            for a in range(16):
                ...
                if a == 14:
                    heli_name = f"Big-Red-Ship Boat"

                if a == 15:
                    heli_name = f"Oil-Rig Boat"
                ...
                if a == 14:
                    save_data[f"Data{file_index} Boat #4 Information"] = {
                        "Dogsled Number": 3,
                        "Vechile Name": heli_name,
                        "Vehicle Hex ID": HELI_ID,
                        "Vehicle Int ID": HELI_INT,
                ...
                if a == 15:
                    save_data[f"Data{file_index} Boat #5 Information"] = {
                        "Dogsled Number": 3,
                        "Vechile Name": heli_name,
                        "Vehicle Hex ID": HELI_ID,
                        "Vehicle Int ID": HELI_INT,
